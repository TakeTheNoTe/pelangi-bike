...
@section('main-content')
    <div class="card-body">
        <div class="table-responsive">
            <a href="{{ route('slider.create') }}" class="btn btn-primary mb-4">Tambah</a>
